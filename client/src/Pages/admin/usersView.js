...
function UsersView() {
    ...
    return (
        <>
            <div>
                <section className="container bg-white mt-3" style={{ overflowX: 'hidden' }}>
                    <div className="">
                        <div className='d-flex justify-content-center'>
                            <h1 className="mt-3 fw-bold border-bottom">Manage Users</h1>
                        </div>
                        <button type="button" class="btn btn-lg btn-primary mt-2 d-flex ms-auto" data-bs-toggle="modal" data-bs-target="#exampleModal">Add User</button>
                                ...
                                <div className="modal-content">
                                    ...
                                    <Form onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <div className="modal-footer">
                                            <Button type="button" ref={buttonRef} className="btn btn-secondary" data-bs-dismiss="modal">Close</Button>
                                        ...
                                        users && users.map(user => {
                                            return (
                                                <tr>
                                                    ...
                                                    <th >{user.email}</th>
                                                    <th >{user.mobile}</th>
                                                    <th ><span><i className="ri-edit-box-line"></i></span> <span className='ps-4'><i className="ri-delete-bin-5-line"></i></span></th>
                                                </tr>
                                            )
                                        })
                                    }
